...
const InstSeedMoney = () => {
    ...
    useEffect(() => {
        const fetchSeedMoneyApplications = async () => {
            try {
                const response = await fetch("http://localhost:5000/getAllSeedMoneyApplications");
                if (!response.ok) {
    ...
    return (
        <div className="container mt-2">
            <h2 className="text-center text-dark mb-4">Institute-wise Seed Money</h2>
